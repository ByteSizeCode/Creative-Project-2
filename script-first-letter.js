$(document).ready(function(){
 ...
 $('#button').click(function(){
     ...
     $.getJSON('https://www.themealdb.com/api/json/v1/1/search.php?f='+searchValue, function(data) {
       ...
       document.getElementsByClassName("genre")[0].firstChild.nodeValue = mealGenre;
         ...
         for(i = 1; i < data.meals.length; i++) {
            ...
            html += '</ul>';
             ...
             $('.wp_pres_slug3').append("<div class = \"BigBox\"><div><br><img class=\"image\"src=\"" + data.meals[i].strMealThumb + "\" width = 300px, height = 300px><h3>" + mealName +  "</h3><p>" + mealType + "</p><p>" + mealGenre + "</p> <div id=\"target\">" + html + "</div></div></div>");
